...
export const EV = Object.freeze({
    ...
    // ── estudio de diseño ──────────────────────────────────────────────
    DESIGN_STATE: 'design:state',           // {from, to}
    DESIGN_DELTA: 'design:delta',           // {id, text, reset}
    DESIGN_COMPOSITION: 'design:composition', // {composition, repairs}
    DESIGN_RENDER: 'design:render',         // {ok, stats, shaderErrors}
    DESIGN_DONE: 'design:done',             // {composition, stats}
