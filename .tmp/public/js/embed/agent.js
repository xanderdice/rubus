...
export async function createAgent(config = {}) {
    ...
    // El modo de aprobación por defecto de la aplicación es 'auto', y aquí eso
    // se contradice con lo documentado: el componente aprueba su plan y encadena
    // los pasos, pero los comandos con efectos SIGUEN preguntando, porque esa
    // respuesta es de un humano. 'manual' con los dos ajustes finos en true dice
    // exactamente eso — los ajustes explícitos ganan al modo.
    engine.config
        .set('agent.approvalMode', config.approvalMode ?? 'manual')
