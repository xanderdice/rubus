...
export function renderMarkdown(text) {
    ...
    // NUL delimita el marcador: es el único carácter que no puede aparecer en
    // el texto del usuario, así que el contenido no puede falsificar uno. Va
    // escrito como escape, nunca como byte crudo (ver AGENTS.md).
